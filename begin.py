...
if __name__=='__main__':#在win系统下必须要满足这个if条件
    ...
    #4 保存表到文件
    print('保存表到文件...')
    save_sql = "select * into outfile \'D:/qiutan_predict/prediction/datasets/league/league_match_data(23).csv\'character set gbk fields terminated by ',' lines terminated by '\n' " \
